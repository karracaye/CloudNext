            ...
            <div className=" w-[100%]">
                {
                    !noscroll ? (
                        ...
                        <div className="w-[100%] flex flex-col lg:flex-row justify-center items-center lg:items-baseline gap-6 pb-10">
                        {slides.map((slide, index) => (
                            <div  key={`${slide.name}-${index}`} className="w-[90%] lg:w-[22%] flex flex-col items-center text-center gap-3 bg-white p-8 px-5 h-full shadow-md rounded-lg relative">
                            <p className="font-bold text-sm">{slide.name}</p>
                            <div className="flex">
                                {Array(slide.star).fill(null).map((_, index) => (
                                <svg
                            ...
                            <svg className="absolute bottom-0 -mb-[17px] rotate-180" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path fill="#ffffff" d="M10.285 3.858c.777-1.294 2.653-1.294 3.43 0l8.468 14.113c.8 1.333-.16 3.029-1.715 3.029H3.532c-1.554 0-2.514-1.696-1.715-3.029z" />
                            </svg>
                            </div>
                        ))}
                        </div>
